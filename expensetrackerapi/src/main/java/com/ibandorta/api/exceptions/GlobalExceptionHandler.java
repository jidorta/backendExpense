package com.ibandorta.api.exceptions;
...
import com.ibandorta.api.entity.ErrorObject;

@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	
	@ExceptionHandler(ResourceNotFounException.class)
	public ResponseEntity<ErrorObject> handleExponseNotFoundException(ResourceNotFounException ex, WebRequest request){
